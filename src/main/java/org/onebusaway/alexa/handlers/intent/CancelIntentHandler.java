...
import static org.onebusaway.alexa.constant.Prompt.USER_EXIT;

/**
 * Handler for AMAZON.CancelIntent intent request (e.g. "Stop" or "Cancel" during the dialog).
 */
public class CancelIntentHandler extends IntentHandler {
    ...
    public Optional<Response> handleWithObaData(final ObaUserDataItem obaUserDataItem, final ObaUserClient obaUserClient) {
        return promptHelper.getResponse(USER_EXIT);
    }
