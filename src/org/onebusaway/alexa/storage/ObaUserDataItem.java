...
public class ObaUserDataItem {
	...
	public void setISBN(int regionId) {
	...
	public void setObaBaseUrl(String obaBaseUrl) {
	...
	public void setCurrentStopCode(String currentStopCode) {
	...
	public void setrRouteFilter(String routeFilter) {
