 ...
 */
package org.onebusaway.io.elements;
 ...
 */
    ...
    /**
     * Returns the color for the route line, or null if this
     * value is not included in the API response
     *
     * @return the color for the route line, or null if this
     * value is not included in the API response
     */
    @Override
    ...
    /**
     * Returns the color for the route text, or null if this
     * value is not included in the API response
     *
     * @return the color for the route text, or null if this
     * value is not included in the API response
     */
    @Override
