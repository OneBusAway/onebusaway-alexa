...
public final class ObaReportProblemWithTripRequest extends RequestBase
    ...
    public static class Builder extends RequestBase.PostBuilderBase {
        ...
        public Builder(String tripId) {
            super(BASE_PATH + "/report-problem-with-trip.json");
            mPostData.queryParam("tripId", tripId);
        }
        ...
        public Builder setServiceDate(long serviceDate) {
            mPostData.queryParam("serviceDate", String.valueOf(serviceDate));
            return this;
        }
        ...
        public Builder setVehicleId(String vehicleId) {
            mPostData.queryParam("vehicleId", vehicleId);
            return this;
        }
        ...
        public Builder setUserOnVehicle(boolean onVehicle) {
            mPostData.queryParam("userOnVehicle", String.valueOf(onVehicle));
            return this;
        }
        ...
        public Builder setUserVehicleNumber(String vehicleNumber) {
            mPostData.queryParam("userVehicleNumber", vehicleNumber);
            return this;
        }
